...
namespace FormEditor.Api
{
	...
	public class WorkflowSelectorController : UmbracoAuthorizedJsonController
	{
        ...
        public IEnumerable<FormWorkflowInfo> GetRegisteredWorkflows()
        {
            return   AppDomain.CurrentDomain
                    ...
                    .Where(x => x.IsInstanceOfType(typeof(FormEditorWorkflow)) && x.IsClass)
                    .Select(x => new FormWorkflowInfo(x));
